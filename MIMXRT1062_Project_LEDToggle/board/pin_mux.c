...
pin_labels:
- {pin_num: F14, pin_signal: GPIO_AD_B0_09, label: USR_LED, identifier: USR_LED}
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of USR_LED on GPIO_B0_03 (pin D8) */
  gpio_pin_config_t USR_LED_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_B0_03 (pin D8) */
  GPIO_PinInit(GPIO2, 3U, &USR_LED_config);
